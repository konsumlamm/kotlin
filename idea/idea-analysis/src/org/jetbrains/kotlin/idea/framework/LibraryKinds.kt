...
interface KotlinLibraryKind {
    val idePlatformKind: IdePlatformKind<*>
}
...
object JSLibraryKind : PersistentLibraryKind<DummyLibraryProperties>("kotlin.js"), KotlinLibraryKind {
    override val idePlatformKind: IdePlatformKind<*>
        get() = JsPlatforms.defaultJsPlatform.idePlatformKind
...
object CommonLibraryKind : PersistentLibraryKind<DummyLibraryProperties>("kotlin.common"), KotlinLibraryKind {
    override val idePlatformKind: IdePlatformKind<*>
        get() = CommonPlatforms.defaultCommonPlatform.idePlatformKind

    override fun createDefaultProperties() = DummyLibraryProperties.INSTANCE!!
}

val PersistentLibraryKind<*>?.idePlatformKind: IdePlatformKind<*>
    get() = when (this) {
        is KotlinLibraryKind -> idePlatformKind
        else -> DefaultIdeTargetPlatformKindProvider.defaultPlatform.idePlatformKind
    }
